...
панель управления для клиентов. Один деплой обслуживает много клиентских
Instagram Business/Creator-аккаунтов.
...
│       ├── Accounts.jsx        # управление всеми бренд-аккаунтами (этап 2)
...
- Один пользователь заводит сколько угодно брендов (страница **Аккаунты**), каждый
  подключается к своему Instagram; вся панель работает в контексте выбранного бренда
